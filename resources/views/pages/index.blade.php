        ...
        {{-- <form class="needs-validation" method="POST">
            ...
            <div class="row mb-3 g-3">
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="validationTagsThreshold" name="tagsClearThreshold[]" multiple
                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-body text-start p-3 w-100">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="w-100">
                                    <p class="text-sm text-secondary mb-1">Keuntungan</p>
                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-body text-start p-3 w-100">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="w-100">
                                    <p class="text-sm text-secondary mb-1">Total Kg</p>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <span class="text-sm text-success font-weight-bolder">
                                            <i class="fa fa-chevron-up text-xs me-1">
                                                </i>55%
                                        </span>
                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-body text-start p-3 w-100">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="w-100">
                                    <p class="text-sm text-secondary mb-1">Hasil Pendapatan</p>
                ...
                <div class="card border shadow-xs mb-4">
                    <div class="card-body text-start p-3 w-100">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="w-100">
                                    <p class="text-sm text-secondary mb-1">Total Transaksi berhasil</p>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex px-2">
                                                <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                                    <img src="/assets/img/small-logos/logo-spotify.svg" class="w-80"
                                                        alt="spotify">
                                                </div>
                                                <div class="my-auto">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                                    <img src="/assets/img/small-logos/logo-invision.svg" class="w-80"
                                                        alt="invision">
                                                </div>
                                                <div class="my-auto">
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex">
                                                <div
                                                    class="border px-1 py-1 text-center d-flex align-items-center border-radius-sm my-auto">
                                                    <img src="/assets/img/logos/mastercard.png" class="w-90 mx-auto"
                                                        alt="mastercard">
                                                </div>
                                                <div class="ms-2">
